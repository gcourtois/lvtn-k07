...
import com.res.java.util.CodePrinter;
...
public class TreeDumper extends DepthFirstVisitor {
    ...
    /**
     * Starts the tree dumper on the line containing the next token visited. For
     * example, if the next token begins on line 50 and the dumper is currently
     * on line 1 of the file, it will set its current line to 50 and continue
     * printing from there, as opposed to printing 49 blank lines and then
     * printing the token.
     */
     ...
     * When using a dumper on a syntax tree more than once, you either need to
     * call this method or startAtNextToken() between each dump.
     */
